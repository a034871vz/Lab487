...
class StartLocation():
    ...
    def drawGrid(self):
        for x in range(100):
            pygame.draw.line(self.window, (222, 222, 222), (x * 15, 0), (x * 15, 600))
            pygame.draw.line(self.window, (222, 222, 222), (0, x * 15), (800, x * 15))

    def draw(self):
        self.controls.clear(self.window, self.drawGrid())
